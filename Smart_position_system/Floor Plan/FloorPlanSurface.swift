...
class FloorPlanSurface: SKNode {
    ...
    private var fullLength: CGFloat {
        return CGFloat(capturedSurface.dimensions.x) * scalingFactor
    }

    private var height: CGFloat {
        return CGFloat(capturedSurface.dimensions.y) * scalingFactor
    }

    private var depth: CGFloat {
        return CGFloat(capturedSurface.dimensions.z) * scalingFactor
    }
